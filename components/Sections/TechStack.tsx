      ...
      <div className="flex flex-wrap justify-center gap-3 md:gap-6 max-w-5xl mx-auto">
        {stack.map((item, i) => (
          <motion.div
            ...
            className="px-5 md:px-8 py-4 md:py-5 border border-[var(--glass-border)] rounded-2xl flex flex-col items-center gap-1 group transition-all liquid-morph hover:bg-[var(--accent-color)] hover:text-[var(--bg-color)]"
          >
